%
% Simplified version of the per-cell analysis function used for the new/old task.
% This cell is a callback function for runForAllCellsInSession.m
%
%
%urut/aug16
function params = NO_singleCellAnalysis_release( timestampsOfCell, figNr, brainAreaOfCell, plabel, params, varargin )
...
if analysisMode==1
    ...
    modeStr='RR';
    stimuliCategories = params.categoryMappingRecog( params.stimuliRecog, 2 );
    ...
    modeStr='LL';
    stimuliCategories = params.categoryMappingLearn( params.stimuliLearn, 2 );
