...
function [T,allSlopes] = NO_behaviorSummary(NOsessions, allLearnSessionsToUse, modeBehavior, doPlot, basepath, modeExcludeSlowRT)
...
for j=1:length(allLearnSessionsToUse) 
    ...
    [typeCountersSame, typeCountersOvernight, bSame, bOvernight, daSame, daOvernight,tmp,tmp,tmp,tmp,errorRateLearn, RTsRecog,RTsLearn,~,~,responses2, recogState2,RTsRecog_vsQonset, StimOff_toQ_delay,StimOn_toOff_delay] = NObehaviorROC_prepare(NOsessions, NOind, -1, 0, basepath, modeExcludeSlowRT);
